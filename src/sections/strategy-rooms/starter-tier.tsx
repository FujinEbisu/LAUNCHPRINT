...
export default function StarterDisplay({ initialStrategy, strategyId }: StarterDisplayProps) {
        ...
        <div className="card-square p-6 min-h-[80vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-4 max-h-[60vh]">
            {initialStrategy ? (
              <div className="bg-muted text-black p-6 shadow-hard-lg border-2 border-black">
                <h3 className="font-bold mb-4 text-lg">Your Complete Marketing Strategy</h3>
          ...
          <div className="pt-4 border-t-2 border-black text-center">
            <p className="text-xs text-muted-foreground">
              Starter tier: Strategy saved to your account • Access all your strategies from your profile
            </p>
          </div>
        </div>
      </div>
